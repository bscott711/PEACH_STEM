...
void initSystemState() {
  ...
  if (xSemaphoreTake(systemStateMutex, portMAX_DELAY) == pdTRUE) {
    ...
    systemState.dishRotationSGThreshold = StorageManager::loadDishRotationSGThreshold(20);
    ...
    systemState.dishLiftSGThreshold = StorageManager::loadDishLiftSGThreshold(20);
